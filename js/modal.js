...
export const showModal = async (puerto) => {
    ...
    modalBody.innerHTML = `
        <div class="flex flex-col w-full p-0 flex-1">
            ...
            <div class="relative h-[220px] md:h-[280px] shrink-0 overflow-hidden flex items-end p-5 md:p-8 text-white md:rounded-t-3xl">
                <img src="${puerto.imatge && puerto.imatge !== 'media/ColldeSoller.webp' ? puerto.imatge : 'media/' + puerto.nom + '.jpg'}" alt="${puerto.nom}" class="absolute inset-0 w-full h-full object-cover z-0" onerror="this.src='media/ColldeSoller.webp'">
